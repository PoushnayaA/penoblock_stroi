...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var nextButton = document.querySelector('.js-next-tab');
  buttons.forEach(function (button) {
    ...
    document.querySelector('.js-next-tab').addEventListener('click', function () {});
  });
  ...
  _emailjsCom.default.init('5PmWz66_umUsErIKy');
  function sendEmail(event) {
    ...
    _emailjsCom.default.send('service_v2zmitf', 'template_ezi20ms', templateParams).then(function (response) {
  ...
  formEl.querySelector('[type="checkbox"]').addEventListener('change', function () {
    if (formEl.querySelector('#name').value && formEl.querySelector('#email').value && formEl.querySelector('[type="checkbox"]').checked) {
      submitButton.removeAttribute('disabled');
    } else {
      submitButton.setAttribute('disabled', 'true');
...
},{"./modules/form-validate/form":11,"./modules/modals/init-modals":17,"./utils/ios-vh-fix":21,"./vendor/swiper":23,"emailjs-com":2}],10:[function(require,module,exports){
"use strict";
